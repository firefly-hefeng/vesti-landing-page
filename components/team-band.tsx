        ...
        <div className="lovable-panel grid gap-6 p-6 md:grid-cols-[minmax(0,240px)_minmax(0,1fr)] md:items-center md:gap-8 md:p-8">
          ...
          <div>
            ...
            <p className="mt-3 max-w-[56ch] text-sm leading-6 text-text-secondary md:text-base md:leading-7">
              An interdisciplinary team from Nanjing University, Fudan and
              SJTU — gold medalists at the AI Hackathon Tour national finals
              and GOSIM Paris 2026 Frontier Creators. Zero to launch in 63
              days, 463 commits.
            </p>
            <Link
              href="/about"
